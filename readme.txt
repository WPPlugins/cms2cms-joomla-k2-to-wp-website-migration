=== CMS2CMS: Automated Joomla K2 to WordPress Migration  ===
...
This plugin provides automated data migration from Joomla K2 to WordPress

== Description ==

With the help of the current plugin, you will be able to move your Joomla K2 content to WordPress without the need to code or copy-paste.
...
= Note: Some of Joomla K2 plugins may be migrated into their equivalents in WordPress. Below is the list: =
* Kunena Forum to bbPress
* Phoca Gallery to NextGen Gallery
* sh404SEF to WordPress SEO by Yoast
...
= CMS2CMS Joomla K2 to WordPress automated migration plugin makes your data transfer simple and quick. Apart from this, you may always count on our assistance: =
* Phone support – 24/7
